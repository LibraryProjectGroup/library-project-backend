...
INSERT INTO `book` (`id`, `library_user`, `title`, `author`, `isbn`, `topic`, `location`) VALUES
	(4, 3, 'JS for Dummies', 'Mikko Mallikas', '123-456-789', 'JS', 'Nevada'),
	(5, 4, 'Java for Babies', 'John Doe', '123-5223-789', 'Java', 'Florida'),
	(6, 5, 'Python for Pets', 'S. Bonsai', '123-456-5623', 'JS', 'Hong Kong');
...
CREATE TABLE IF NOT EXISTS `borrowing` (
  ...
  KEY `book` (`book`),
  CONSTRAINT `FK_borrowing_book` FOREIGN KEY (`book`) REFERENCES `book` (`id`),
  CONSTRAINT `FK_borrowing_library_user` FOREIGN KEY (`library_user`) REFERENCES `library_user` (`id`)
...
INSERT INTO `borrowing` (`id`, `library_user`, `book`, `dueDate`, `borrowDate`, `returned`) VALUES
	(5, 3, 4, '2022-08-20', '2022-08-13', b'1'),
