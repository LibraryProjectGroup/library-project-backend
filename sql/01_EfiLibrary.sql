...
) COMMENT ='data entry that shows which book was borrowed and when and by which library user';
...
INSERT INTO library_user (id, username, email, passw, administrator)
VALUES (1, 'hemuli', 'hemuli@place.holder', 'qweqweqwe', 0),
       ...
       (9, 'testattavatyyppi', 'etu.suku@doesnt.exist', '$2b$08$4LdND6u7LymHX5DCBtmyweaYCOxKvUY6Rd9Z4N4cWQalAVtBSBOvi',
        0),
       (10, 'testuser', 'test@user.com', 'T3st_Us3r', 0);

INSERT INTO book (id, library_user, title, author, year, isbn, topic, location)
VALUES (1, 1, 'JS for Dummies', 'Mikko Mallikas', 2000, '123-456-789', 'JS', 'Nevada'),
...
INSERT INTO borrowing (id, library_user, book, dueDate, borrowDate, returned)
VALUES (1, 1, 2, '2022-08-20', '2022-08-13', 0),
